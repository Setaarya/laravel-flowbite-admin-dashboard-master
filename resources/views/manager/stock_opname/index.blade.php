...
<div class="container mx-auto p-6">
    ...
    <div class="mb-4">
        <a href="{{ route('manager.export.stock.opname', 'xlsx') }}" class="bg-blue-500 text-white px-4 py-2 rounded-md shadow-md hover:bg-blue-600">
            Export to Excel
        </a>
        <a href="{{ route('manager.export.stock.opname', 'csv') }}" class="bg-green-500 text-white px-4 py-2 rounded-md shadow-md hover:bg-green-600">
            Export to CSV
        </a>
    </div>
